...
export declare class EntityDef<Attrs extends AttrsDefs, Links extends Record<string, LinkAttrDef<any, any>>, AsType> {
    ...
    asType<_AsType extends Partial<MappedAttrs<Attrs>>>(): EntityDef<Attrs, Links, _AsType>;
}
...
type RequiredKeys<Attrs extends AttrsDefs> = {
    [K in keyof Attrs]: Attrs[K] extends DataAttrDef<any, infer R> ? R extends true ? K : never : never;
}[keyof Attrs];
type OptionalKeys<Attrs extends AttrsDefs> = {
    [K in keyof Attrs]: Attrs[K] extends DataAttrDef<any, infer R> ? R extends false ? K : never : never;
}[keyof Attrs];
/**
 * MappedAttrs:
...
export type ResolveEntityAttrs<EDef extends EntityDef<any, any, any>, ResolvedAttrs = MappedAttrs<EDef['attrs']>> = EDef extends EntityDef<any, any, infer AsType> ? AsType extends void ? ResolvedAttrs : Omit<ResolvedAttrs, keyof AsType> & AsType : ResolvedAttrs;
