...
import type { Query, QueryResponse, InstaQLResponse, PageInfoResponse, Exactly, InstantObject, InstaQLParams, InstaQLOptions, InstaQLQueryParams, InstaQLEntity, InstaQLResult, InstaQLFields } from './queryTypes';
...
declare class Storage {
     ...
     */
    uploadFile: (path: string, file: File, opts?: FileOpts) => Promise<UploadFileResponse>;
    /**
